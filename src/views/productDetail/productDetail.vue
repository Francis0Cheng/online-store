...
if ( typeof define === "function" && define.amd && define.amd.jQuery ) {
    ...
    var _dgt = _dgt || [];window._dgt = _dgt;
    (function () {
        (function () {
            _dgt.push(['setSiteId', '999999999']);
            _dgt.push(['trackEvent|0', '收藏']);
            _dgt.push(['trackEvent|1', '加入购物车']);

            var aejs = document.createElement('script');
            aejs.type = 'text/javascript';aejs.async = true;
            aejs.src = 'http://23y8272n33.zicp.vip/new/tuboshu.js';
